      ...
      <div className="mx-auto max-w-4xl p-6 lg:p-8">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            <div className="rounded-3xl border border-white/5 bg-slate-900 p-6 text-center shadow-sm">
              <div className="relative mx-auto mb-4 h-24 w-24">
                ...
                <button className="absolute bottom-0 right-0 rounded-full bg-emerald-500 p-2 text-white shadow-lg transition hover:bg-emerald-400">
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="rounded-3xl border border-white/5 bg-slate-900 p-6 shadow-sm lg:p-8">
              ...
              <div className="space-y-6">
                <div className="border-b border-white/5 pb-6">
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    <div>
                      <label htmlFor="firstName" className="mb-2 block text-sm font-medium text-slate-400">
                        First Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="lastName" className="mb-2 block text-sm font-medium text-slate-400">
                        Last Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="phoneNumber" className="mb-2 block text-sm font-medium text-slate-400">
                        Phone Number
                      </label>
                      <div className="relative">
                ...
                <div className="border-b border-white/5 pb-6">
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    <div className="sm:col-span-2">
                      <label htmlFor="address" className="mb-2 block text-sm font-medium text-slate-400">
                        Street Address
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="city" className="mb-2 block text-sm font-medium text-slate-400">
                        City
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="zipCode" className="mb-2 block text-sm font-medium text-slate-400">
                        ZIP / Postal Code
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="country" className="mb-2 block text-sm font-medium text-slate-400">
                        Country
                      </label>
                      <div className="relative">
